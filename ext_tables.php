...
(static function() {
    ...
    $GLOBALS['TCA']['tt_content']['types']['list']['subtypes_addlist']['musikschule_news'] = 'pi_flexform';
     \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPiFlexFormValue('musikschule_news', 'FILE:EXT:musikschule_news/Configuration/Flexform/flexform.xml');
})();
