...
return [
    'ctrl' => [
        'title' => 'LLL:EXT:indiz_news/Resources/Private/Language/locallang_db.xlf:tx_indiznews_domain_model_category',
        'label' => 'title',
        'tstamp' => 'tstamp',
        'crdate' => 'crdate',
        'cruser_id' => 'cruser_id',
    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND {#tx_indiznews_domain_model_category}.{#pid}=###CURRENT_PID### AND {#tx_indiznews_domain_model_category}.{#sys_language_uid} IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
        ...
        'title' => [
            'exclude' => true,
            'label' => 'LLL:EXT:indiz_news/Resources/Private/Language/locallang_db.xlf:tx_indiznews_domain_model_category.title',
            'config' => [
                'type' => 'input',
                'size' => 30,
                'eval' => 'trim',
